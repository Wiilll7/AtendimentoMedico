...
public class Interface extends javax.swing.JFrame {
    ...
    public Interface(Fila fila, List<Medico> listaMedicos) {
        this.fila = fila;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Random r = new Random();
        Medico m = listaMedicos.get(r.nextInt(3));
    ...
    public static void main(String args[]) {
        ...
        fila.iniciaFila();
        java.awt.EventQueue.invokeLater(() -> new Interface(fila, listaMedicos).setVisible(true));
    }
